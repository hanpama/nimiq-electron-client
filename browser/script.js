class DevUi {
    ...
    _loadUiComponents() {
        ...
        return Promise.all(scripts.map(script => Utils.loadScript(`browser/${script}`)));
    }
    ...
    _startInstance() {
        return new Promise(resolve => {
            Nimiq.init(() => {
                ...
                const config = Nimiq.GenesisConfig.CONFIGS[this.networkName] || Nimiq.GenesisConfig.CONFIGS['main'];
